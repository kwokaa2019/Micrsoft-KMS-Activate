...
echo                               注意事項
echo.
echo      此認證程式僅適用在 Microsoft Windows 11 Enterprise LTSC  作業系統，不適用其他作業系統。
echo.
echo      This certifi program is only applicable to Microsoft Windows 11 Enterprise LTSC operating system, not to other operating systems.。
echo.
echo ----------------------------------------------------------------------
